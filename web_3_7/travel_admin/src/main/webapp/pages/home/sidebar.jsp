        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="route/findRoutesByPage" onclick="setSidebarActive(this)" target="iframe">线路查询</a></li>
                    <li><a href="route/findSellerAndCategories" onclick="setSidebarActive(this)" target="iframe">线路添加</a></li>
                </ul>
            </li>
        </ul>
        <!-- /.sidebar-menu -->
